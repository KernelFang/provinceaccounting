...
<div class="row">
                ...
                <div class="bootselect-multiselect">
                    <select class="selectpicker" data-live-search="true" id="purpose" name="purpose" required>
                        <option value="" disabled
                            {{ is_null(old('purpose', $visa->purpose ?? null)) ? 'selected' : '' }}>
                            Select
                        </option>
                        @foreach ($purposes as $p)
                            <option value="{{ $p->name }}" @selected(old('purpose', $visa->purpose ?? null) === $p->name)>
                                {{ $p->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-style1">
                ...
                <div class="bootselect-multiselect">
                    <select class="selectpicker" data-live-search="true" id="country" name="country" required>
                        <option value="" disabled
                            {{ is_null(old('country', $visa->country ?? null)) ? 'selected' : '' }}>
                            Select
                        </option>
                        @foreach ($countries as $c)
                            <option value="{{ $c->name }}" @selected(old('country', $visa->country ?? null) === $c->name)>
                                {{ $c->name }}
                            </option>
                        @endforeach
                    </select>
    ...
    <div class="col-sm-6">
        <div class="mb20">
            <x-input-label class="heading-color" for="from_date" :value="__('File Received Date')" />
            <x-text-input type="date" class="form-control" id="from_date" name="from_date" :value="old('from_date', isset($visa->from_date) ? $visa->from_date->format('Y-m-d') : '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            <x-input-label class="heading-color" for="to_date" :value="__('File Submission Date')" />
            <x-text-input type="date" class="form-control" id="to_date" name="to_date" :value="old('to_date', isset($visa->to_date) ? $visa->to_date->format('Y-m-d') : '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="date" class="form-control" id="purchase_date" name="purchase_date"
                :value="old('purchase_date', isset($visa->purchase_date) ? $visa->purchase_date->format('Y-m-d') : '')"/>
            ...
            <div class="form-style1">
                ...
                <div class="bootselect-multiselect">
                    <select class="selectpicker" data-live-search="true" id="status" name="status" required>
                        <option value="" disabled
                            {{ is_null(old('status', $visa->status ?? null)) ? 'selected' : '' }}>
                            Select
                        </option>
                        <option value="pending" @selected(old('status', $visa->status ?? null) === 'pending')>Pending</option>
                        <option value="inprogress" @selected(old('status', $visa->status ?? null) === 'inprogress')>In Progress</option>
                        <option value="completed" @selected(old('status', $visa->status ?? null) === 'completed')>Completed</option>
                        <option value="cancelled" @selected(old('status', $visa->status ?? null) === 'cancelled')>Cancelled</option>
                        <option value="paused" @selected(old('status', $visa->status ?? null) === 'paused')>Paused</option>
                    </select>
                </div>
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="text" class="form-control" id="customer" name="customer" :value="old('customer', $visa->customer ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" class="form-control" id="person" name="person" :value="old('person', $visa->person ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="text" class="form-control" id="mobile_number" name="mobile_number"
                :value="old('mobile_number', $visa->mobile_number ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="text" class="form-control" id="emergency_number" name="emergency_number"
                :value="old('emergency_number', $visa->emergency_number ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" step="0.01" min="0" class="form-control" id="agent_cost"
                name="agent_cost" :value="old('agent_cost', $visa->agent_cost ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" step="0.01" min="0" class="form-control" id="customer_price"
                name="customer_price" :value="old('customer_price', $visa->customer_price ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" step="0.01" min="0" class="form-control" id="customer_payment"
                name="customer_payment" :value="old('customer_payment', $visa->customer_payment ?? '')" />
    ...
    <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" step="0.01" min="0" class="form-control" id="customer_due"
                name="customer_due" :value="old('customer_due', $visa->customer_due ?? '')" readonly />
    ...
    {{-- <div class="col-sm-6">
        <div class="mb20">
            ...
            <x-text-input type="number" step="0.01" min="0" class="form-control" id="profit"
                name="profit" :value="old('profit', $visa->profit ?? '')" />
    ...
    <div class="col-md-12">
        <div class="mb10">
            ...
            <textarea class="character-count" maxlength="400" cols="30" rows="4" name="description"
                id="description" placeholder="Description (Max 400 characters)">{{ old('description', $visa->description ?? '') }}</textarea>
