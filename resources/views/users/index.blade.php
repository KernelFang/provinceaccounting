        ...
        <div class="col-xl-12">
            ...
            <div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @canany(['users.*', 'users.restore', 'users.force-delete'])
                        <div class="d-flex gap-2">
                            <a href="{{ route('users.index') }}" class="btn btn-sm btn-outline-primary">All</a>
                            <a href="{{ route('users.index', array_merge(request()->query(), ['with_trashed' => 1])) }}"
                                class="btn btn-sm btn-outline-secondary">With Trashed</a>
                            <a href="{{ route('users.index', array_merge(request()->query(), ['only_trashed' => 1])) }}"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            @if (method_exists($user, 'trashed') && $user->trashed())
                                                @canany(['users.*', 'users.restore', 'users.force-delete'])
                                                    <x-delete-restore-buttons routePrefix="users" :model="$user" />
                                                @endcanany
                                            @endif
                                        </div>
                                    </td>
