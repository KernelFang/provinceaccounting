<x-app-layout>
    <x-slot name="title">{{ __('Petty Cash') . ' ' . __('Details') }}</x-slot>

    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Petty Cash') . ' ' . __('Details') }}
        </h2>
    </x-slot>
                                ...
                                <div class="col-lg-8">
                                    <div class="column" id="printable-area">
                                        <div class="price-widget pt25 bdrs8">
                                            <h4><i
                                                    class="fa fa-file-invoice-dollar text-thm2 pe-2 vam align-baseline"></i>{{ __('Petty Cash') . ' ' . __('Details') }}
                                            </h4>
                                            <div class="category-list mt20">
                                                ...
                                                <p class="d-flex align-items-center justify-content-between bdrb1 pb-2">
                                                    ...
                                                    <span>{{ rtrim(rtrim(number_format($pettyCash->amount, 2), '0'), '.') }}</span>
                                                </p>

                                                <p class="d-flex align-items-center justify-content-between bdrb1 pb-2">
                                                    <span class="text">
                                                        <i class="fa fa-calendar-alt text-thm2 pe-2 vam"></i> Date
                                                    </span>
                                                    <span>{{ $pettyCash->date ? $pettyCash->date->format('d M Y') : 'N/A' }}</span>
                                                </p>
                                                ...
                                                <p class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <span>{{ $pettyCash->user->name ?? ($pettyCash->created_by ? 'User #' . $pettyCash->created_by : 'N/A') }}</span>
                                                </p>
                                        ...
                                        <div class="service-about">
                                            <div class="p30 mb30 bg-white bdrs12 wow fadeInUp default-box-shadow1 bdr1">
                                                ...
                                                <p class="text mb30">
                                                    {{ $pettyCash->description ?? 'No description provided' }}</p>
                                            </div>
                                        </div>
                                    </div>
